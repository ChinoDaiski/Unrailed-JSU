...
HRESULT CLevel_GamePlay::NativeConstruct()
{
	...
	CSoundMgr::Get_Instance()->PlayBGM(TEXT("GamePlay_Basic4.mp3"), 0.3f);		// 설원맵은 BGM4,6번 제외하고 바꾸기
...
HRESULT CLevel_GamePlay::Ready_Layer_MapObject(const _tchar * pLayerTag)
{
	...
	Load_MapToolData(TEXT("EasyMap.dat"));			// 설원맵은 'snowmap4'로 바꾸기
...
HRESULT CLevel_GamePlay::Ready_Layer_MSignUI(const _tchar * pLayerTag)
{
	...
	tradesc2.m_WorldMatrix.m[3][2] = targetpos.z + 104.f;
